...
public class Ex24Melhorado {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 
		 *  -=- Coisas para tentar fazer e melhorar o código -=-
		 * 
		 * -> Fazer com cartão bandeira (while/"Quer cadastrar mais um funcionario?")
		 * 
		 * -> Usar strings concatenadas para armazenar os valores e mostrar tudo em
		 *    uma só mensagem no final (tipo um relatorio)
		 *    
		 * -> Usar caixas de diálogo com mais campos
		 * 
		 * -> custoMdo = custoMaoObra
		 * -> qntPorPeca -> unPeca
		 * 
		 * -> if i != 1
		 *  (ifs de verificacao maior/menor)
		 * 	else {define primeiro como maior e menor]
		 * 
		 */
